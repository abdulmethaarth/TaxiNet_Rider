...
import co.webnexs.taxinetrider.beens.TripDetails;
import co.webnexs.taxinetrider.adapter.TripDetailsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newRide.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent (AllTripActivity.this, co.webnexs.taxinetrider.activity.HomeActivity.class);
