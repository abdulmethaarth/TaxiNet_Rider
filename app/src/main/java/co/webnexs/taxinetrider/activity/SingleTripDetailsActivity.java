...
import co.webnexs.taxinetrider.utils.SimpleRatingBar;
...
public class SingleTripDetailsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void singleRideDetails() {
        ...
        Call<co.webnexs.taxinetrider.beens.SingleTripDetails> userCall = api.getSingleTripDetail(user_id,ride_id);
        userCall.enqueue(new Callback<co.webnexs.taxinetrider.beens.SingleTripDetails>() {
            @Override
            public void onResponse(Call<co.webnexs.taxinetrider.beens.SingleTripDetails> call, retrofit2.Response<co.webnexs.taxinetrider.beens.SingleTripDetails> response) {

                co.webnexs.taxinetrider.beens.SingleTripDetails baseResponse = response.body();
                if (baseResponse.status.equalsIgnoreCase("true")) {
                    co.webnexs.taxinetrider.beens.SingleTripDetails.SingleTrip data = baseResponse.getDetails();
            ...
            @Override
            public void onFailure(Call<co.webnexs.taxinetrider.beens.SingleTripDetails> call, Throwable t) {
